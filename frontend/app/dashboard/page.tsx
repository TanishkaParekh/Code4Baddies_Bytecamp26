      ...
      <div style={{ minHeight: "100vh", background: C.cream, fontFamily: "'DM Sans', sans-serif", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", flex: 1 }}>
          ...
          <main style={{ flex: 1, padding: "32px 36px", overflowY: "auto" }}>
            ...
            {tab === "past" && (
              <div>
                <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 28, color: C.text, marginBottom: 20 }}>
                  Past Medication Checks
                </h1>

                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {PAST_CHECKS.map(check => (
                    <div key={check.id} className="history-row">
                      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        <div
                          style={{
                            width: 36,
                            height: 36,
                            borderRadius: 10,
                            background: check.risk === "SAFE" ? "#DCFCE7" : "#FEE2E2",
                            display: "flex",
                            alignItems: "center",
                        ...
                        <div>
                          <div style={{ fontWeight: 600 }}>{check.drugs}</div>
                          <div style={{ fontSize: 12, color: C.textLight }}>{check.date}</div>
                        </div>
                      </div>
              ...
              <div>
                ...
                <div
                  style={{
                    ...
                    borderRadius: 20,
                    padding: "28px 30px",
                    border: "1px solid rgba(46,125,138,0.08)",
                ...
                >
                  ...
                  >
                    <div>
                      <div style={{ fontSize: 11, color: C.textLight }}>Email</div>
                      <div style={{ fontWeight: 500 }}>{user?.email}</div>
                    </div>

                    <div>
                      <div style={{ fontSize: 11, color: C.textLight }}>User ID</div>
                    ...
                    <div>
                      <div style={{ fontSize: 11, color: C.textLight }}>Account Type</div>
                      <div style={{ fontWeight: 500 }}>Standard Patient Account</div>
                    </div>
                  </div>
